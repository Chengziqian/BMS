<?php
    ...
    if(isset($_POST['action'])){
        ...
        if($_POST['action']==='user_info'){
            header('Location:user_info.html?id='.$id);
        }
...
<html>
    ...
    <body>
        ...
        --><div style="display: inline-block;width: 700px;height: 100%;overflow: hidden;white-space: nowrap;vertical-align:top;margin: 0;padding: 0;">
            <div style="width: 292px;height: 336px;display: inline-block;position: relative;left: 70px;top:50px;z-index: 3"><a href="#"><img src="./icons/fun1.png"width="292px" height="336px" onmouseover="this.src='./icons/fun1_l.png'"onmouseout="this.src='./icons/fun1.png'" ></a></div>
            ...
            <div style="width: 292px;height: 336px;position: relative;top:50px;left: -220px;display: inline-block;z-index: 3;"><?php if($user_type==1) echo '<a href="#">';?><img src="<?php if($user_type==1) echo'./icons/fun2.png'; else echo './icons/fun2_disabled.png';?>"width="292px" height="336px" onmouseover="<?php if($user_type==1) echo "this.src='./icons/fun2_l.png'"; else echo ""?>"  onmouseout="<?php if($user_type==1) echo "this.src='./icons/fun2.png'"; else echo ""?>" ><?php if($user_type==1) echo '</a>';?></div>
            </div>
